---
title: Class TimeDetailed
sidebar_label: TimeDetailed
description: "Text display menu TimeDetailed input item"
---
# Class TimeDetailed
Text display menu TimeDetailed input item

###### **Assembly**: TextDisplayMenu.dll
###### [View Source](https://github.com/WildernessLabs/Meadow.Foundation.git/blob/develop/Source/Meadow.Foundation.Libraries_and_Frameworks/Displays.TextDisplayMenu/Driver/InputTypes/TimeDetailed.cs#L6)
```csharp title="Declaration"
public class TimeDetailed : TimeBase, IMenuInputItem, IPage
```
