...
title: Class Age
sidebar_label: Age
description: "Age input type"
---
# Class Age
Age input type

###### **Assembly**: TextDisplayMenu.dll
###### [View Source](https://github.com/WildernessLabs/Meadow.Foundation.git/blob/develop/Source/Meadow.Foundation.Libraries_and_Frameworks/Displays.TextDisplayMenu/Driver/InputTypes/Age.cs#L6)
```csharp title="Declaration"
public class Age : NumericBase, IMenuInputItem, IPage
```
