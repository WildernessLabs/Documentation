...
![Illustration of a water pipe with a flow-limiting valve in the center of it, representing a resistor.](../Support_Files/Resistor_Valve.svg){:standalone}
...
![Circuit diagram showing a circuit loop with a resistor at the top of the loop, and a source voltage at the bottom of the loop.](../Support_Files/Ohms_Circuit.svg){:standalone}
