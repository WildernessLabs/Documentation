...
![Charting of a wave form in the 5-volt range being passed through signal division to a chart of the same wave scaled down to 3.3 volts.](../Support_Files/5V_to_3.3V_Signal_Division.svg){:standalone}
