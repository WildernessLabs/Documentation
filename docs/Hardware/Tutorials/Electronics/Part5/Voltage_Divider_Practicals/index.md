...
![Charting of a wave form in the 5-volt range being passed through signal division to a chart of the same wave scaled down to 3.3 volts.](../Support_Files/5V_to_3.3V_Signal_Division.svg)
...
![Photo of a pair of potentiometers, each with three leg pins, but one has a metal post for attaching a knob and the other has a small integrated knob.](Potentiometers.jpg)
...
![Diagram of a voltage through two resistors, R1 and R2, where the load across R2 is labeled parallel resistance.](../Support_Files/Voltage_Divider_Third_Leg.svg)
