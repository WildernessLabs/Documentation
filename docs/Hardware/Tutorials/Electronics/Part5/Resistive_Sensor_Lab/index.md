...
![Schematic of connecting a Netduino to a resistor and resistive sensor with the Netduino represented as a single box with leads for the pins connected to the resistors.](Photoresistor_Circuit_schem.svg)
