...
1. Reserve the pins `I9` and `H13`, which are used to exchange data between the modem and the **Meadow F7v2 Feather**, and the `C7`, which is used to turn on the modules:
    ...
    > **Notes**: You can find the pins `I9`, `H13` and `C7` as `D00`, `D01` and `D10` on the **Meadow F7v2 Feather**, respectively. If you use different pins, you should reserve the corresponding ones, according to the pinout definition present in the [**Meadow F7v2 Feather** datasheet](../../Meadow_Basics/Hardware/Wilderness_Labs_Meadow_F7v2_Datasheet.pdf). For instance, if you want to utilize the `A02` **Meadow F7v2 Feather** pin to turn on the module, you should reserve the corresponding `A3` MCU pin, instead of `C7`.
...
![Quectel BG770A/Meadow Cell Wing with Meadow F7v2 Feather setup.](images/cell_wing.jpeg){: .center-image :standalone}
...
![Quectel BG95-M3/NimbeLink Skywire click board with Meadow F7v2 Feather setup](images/bg95.jpeg){: .center-image :standalone}
...
![Quectel M95/GSM2 click board with Meadow F7v2 Feather setup using an external energy supply connected to the 5V and GND pins.](images/m95.jpeg){: .center-image :standalone}
