...
Check out the [FileSystem_Basics app sample in Meadow.Samples](https://github.com/WildernessLabs/Meadow.Samples/tree/main/Source/Meadow%20F7/OS/FileSystem_Basics) to see it in action.
