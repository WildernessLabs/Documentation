...
title: Class YfB9
sidebar_label: YfB9
description: Driver for the YF-B9 Hall effect water flow sensor.
...
###### [View Source](https://github.com/WildernessLabs/Meadow.Foundation.git/blob/develop/Source/Meadow.Foundation.Peripherals/Sensors.Flow.HallEffect/Driver/Drivers/YfB9.cs#L13)
```csharp title="Declaration"
public class YfB9 : HallEffectBase, IObservable<IChangeResult<VolumetricFlow>>, ISamplingSensor<VolumetricFlow>, ISamplingSensor, IVolumetricFlowSensor, ISensor<VolumetricFlow>, ISensor
```
