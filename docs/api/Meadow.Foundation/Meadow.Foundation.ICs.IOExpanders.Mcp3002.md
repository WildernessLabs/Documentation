...
###### [View Source](https://github.com/WildernessLabs/Meadow.Foundation/blob/main/Source/Meadow.Foundation.Peripherals/ICs.ADCs.Mcp3xxx/Driver/Drivers/Mcp3002.cs#L8)
```csharp title="Declaration"
public class Mcp3002 : Mcp3xxx, IAnalogInputController, IPinController, ISpiPeripheral, IDisposable
```
...
### Pins
The pins
###### [View Source](https://github.com/WildernessLabs/Meadow.Foundation/blob/main/Source/Meadow.Foundation.Peripherals/ICs.ADCs.Mcp3xxx/Driver/Drivers/Mcp3002.cs#L13)
```csharp title="Declaration"
