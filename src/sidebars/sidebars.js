...
const sidebars = {
  ...
  meadowApiSidebar: [{ type: "autogenerated", dirName: "api/Meadow" }],
  meadowFoundationApiSidebar: [{ type: "autogenerated", dirName: "api/Meadow.Foundation" }],
  meadowFoundationFeatherWingsApiSidebar: [{ type: "autogenerated", dirName: "api/Meadow.Foundation.FeatherWings" }],
  meadowFoundationGroveApiSidebar: [{ type: "autogenerated", dirName: "api/Meadow.Foundation.Grove" }],
  meadowFoundationMikroBUSApiSidebar: [{ type: "autogenerated", dirName: "api/Meadow.Foundation.mikroBUS" }],
